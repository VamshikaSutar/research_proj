...
function textChanged() {
	...
	var html = "";
	if(score.male > score.female) html = "Neutral ("+scoreIt(score.male,score.female)+"%)";
	if(score.male < score.female) html = "Gendered ("+scoreIt(score.female,score.male)+"%)";
	if(score.male == score.female) html = "Neutral";
